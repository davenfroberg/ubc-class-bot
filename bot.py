...
def run_discord_bot():
    TOKEN = 'MTEyMDU3MTM2MzE2MjMzNzMyMQ.GbvpMP.zUChiFNFTxIWHTm0Mv4DkjFYOiNEiiQ1Hh6RqA'
    ...
    async def first_command(interaction, course_code: str, course_number: str):
        ...
        if (request.status_code == 200):
            ...
            await interaction.response.send_message(f'{code} {course_number}: {title} \nAverage: {average}% \n' + ssc)
        else:
